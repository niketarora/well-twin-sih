...
export const EquipmentPage: React.FC = () => {
  ...
  return (
    <div className="space-y-5">
      <SectionHeader
        title="Equipment Health & Mechanical Integrity"
        subtitle="Operational runtime, Goodman stress margins, and scheduled maintenance intervals across Well BW-017 surface and downhole assemblies."
        badge="5 Subsystems Monitored"
        badgeType="default"
      />
        ...
        {equipmentList.map((eq) => (
          ...
          >
            <div>
              ...
              <h3 className="font-heading font-bold text-sm text-ink mt-2.5">
                {eq.name}
              </h3>
              ...
              <div className="grid grid-cols-2 gap-3 my-3 p-2.5 bg-surface-secondary rounded-lg border border-border-subtle font-mono text-xs">
                <div>
                  <span className="text-[9.5px] text-ink-muted font-sans uppercase block">Health Score</span>
                  <span
                ...
                <div>
                  <span className="text-[9.5px] text-ink-muted font-sans uppercase block">Operating Runtime</span>
              ...
              <div className="space-y-1.5 font-mono text-xs">
                {eq.parameters.map((p, idx) => (
                  <div
                    key={idx}
                    className="flex justify-between items-center p-1.5 rounded hover:bg-canvas-subtle transition-colors"
                  >
            ...
            <div className="mt-4 pt-3 border-t border-border-subtle flex items-center justify-between text-xs text-ink-muted">
              ...
              {eq.activeAlertsCount > 0 ? (
                <button
                  ...
                  className="text-status-crit font-bold flex items-center gap-1 hover:underline"
                >
